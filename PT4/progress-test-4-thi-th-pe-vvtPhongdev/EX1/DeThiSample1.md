...
| TODO-10A | CarTypeDetail — fetch data (Promise.all), redirect to 404 for invalid id, display car list | 2.0 |
| **Total** | | **10.0** |
...
| TODO-10: CarTypeDetail | `src/pages/CarTypeDetail.jsx` | 2.0 |
| **TOTAL** | | **10.0** |
